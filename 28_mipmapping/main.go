...
func (app *HelloTriangleApplication) createTextureImage() error {
	...
	//Create final image
	app.textureImage, app.textureImageMemory, err = app.createImage(imageDims.X, imageDims.Y, app.mipLevels, core1_0.DataFormatR8G8B8A8SRGB, core1_0.ImageTilingOptimal, core1_0.ImageUsageTransferSrc|core1_0.ImageUsageTransferDst|core1_0.ImageUsageSampled, core1_0.MemoryPropertyDeviceLocal)
	if err != nil {
		return err
	}
	...
	err = app.generateMipmaps(app.textureImage, core1_0.DataFormatR8G8B8A8SRGB, imageDims.X, imageDims.Y, app.mipLevels)
	if err != nil {
		return err
	}
...
func (app *HelloTriangleApplication) createImageView(image core1_0.Image, format common.DataFormat, aspect common.ImageAspectFlags, mipLevels int) (core1_0.ImageView, error) {
	imageView, _, err := app.loader.CreateImageView(app.device, nil, core1_0.ImageViewOptions{
		Image:    image,
...
func (app *HelloTriangleApplication) createImage(width, height int, mipLevels int, format common.DataFormat, tiling common.ImageTiling, usage common.ImageUsages, memoryProperties common.MemoryProperties) (core1_0.Image, core1_0.DeviceMemory, error) {
	image, _, err := app.loader.CreateImage(app.device, nil, core1_0.ImageOptions{
...
func (app *HelloTriangleApplication) createDescriptorPool() error {
	var err error
	app.descriptorPool, _, err = app.loader.CreateDescriptorPool(app.device, nil, core1_0.DescriptorPoolOptions{
