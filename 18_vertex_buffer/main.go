...
func (app *HelloTriangleApplication) createVertexBuffer() error {
	...
	app.vertexBuffer, _, err = app.device.CreateBuffer(&resources.BufferOptions{
	...
	memRequirements, err := app.vertexBuffer.MemoryRequirements()
	if err != nil {
		return err
	}
	...
	app.vertexBufferMemory, _, err = app.device.AllocateMemory(&resources.DeviceMemoryOptions{
